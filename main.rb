...
manager = Actualize::Manager.new(first_name: "Corey", last_name: "Feldman", salary: 100000, active: true, employees: [employee1, employee2])


intern = Actualize::Intern.new(first_name: "Benji", last_name: "Pang", salary: 30000, active: true)
intern.print_info
intern.send_report